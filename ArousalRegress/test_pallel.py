...
from train_eval_pallel import train, init_network
...
train_iter = Data.DataLoader(data, batch_size=batch_size*len(device_ids),shuffle=False, drop_last=False, sampler=train_idx)
dev_iter = Data.DataLoader(data, batch_size=batch_size*len(device_ids), shuffle=False,drop_last=False, sampler=val_idx)
test_iter = Data.DataLoader(data, batch_size=batch_size*len(device_ids), shuffle=False,drop_last=False, sampler=val_idx)


print(model.parameters)
train(config, model, train_iter, dev_iter, test_iter,device_ids)
